...
gyp ERR! stack Error: Command failed: C:\Users\Lukasz\AppData\Local\Programs\Python\Python37-32\python.EXE -c import sys; print "%s.%s.%s" % sys.version_info[:3];
...
gyp ERR! cwd H:\projekty pai\routing+menu\node_modules\websocket
